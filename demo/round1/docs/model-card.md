...
consumer loan applications up to 50,000 EUR. Recommendations for refer
and decline are subject to mandatory human review.

## Out of scope

- Business lending
- Mortgage decisions
- Any fully automated adverse decision
...
- Model reasons are explanatory aids, not statutory adverse action
  reasons; reviewers own final communication wording.
